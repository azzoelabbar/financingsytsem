...
/**
* @see \App\Http\Controllers\Api\V1\ReportsController::balanceSheet
 * @see app/Http/Controllers/Api/V1/ReportsController.php:24
...
/**
* @see \App\Http\Controllers\Api\V1\ReportsController::profitAndLoss
 * @see app/Http/Controllers/Api/V1/ReportsController.php:35
...
/**
* @see \App\Http\Controllers\Api\V1\ReportsController::cashFlow
 * @see app/Http/Controllers/Api/V1/ReportsController.php:46
...
/**
* @see \App\Http\Controllers\Api\V1\ReportsController::managementPack
 * @see app/Http/Controllers/Api/V1/ReportsController.php:57
 * @route '/api/v1/reports/management-pack'
 */
...
managementPack.definition = {
    methods: ["get","head"],
    url: '/api/v1/reports/management-pack',
} satisfies RouteDefinition<["get","head"]>
...
const ReportsController = { balanceSheet, profitAndLoss, cashFlow, managementPack }
