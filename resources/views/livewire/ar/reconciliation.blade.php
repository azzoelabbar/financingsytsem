        ...
        <div class="mx-auto max-w-2xl overflow-hidden rounded-lg border border-border bg-card">
            ...
            <dl class="divide-y divide-border">
                <div class="flex items-center justify-between gap-4 px-5 py-3">
                    <dt class="text-sm text-muted-foreground">{{ __('erp.reconciliation.gl_balance_ar') }}</dt>
                    <dd><x-ui.money :amount="$glBalance" :negative="(float) $glBalance < 0" /></dd>
                </div>
                <div class="flex items-center justify-between gap-4 px-5 py-3">
                    <dt class="text-sm text-muted-foreground">{{ __('erp.reconciliation.subledger_ar') }}</dt>
